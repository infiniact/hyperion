...
use crate::{
    plugin::{
        ...
        cityweather::CityWeatherPlugin, creatures::CreaturesPlugin, damage::DamagePlugin,
        lotus::LotusPlugin,
        npc::NpcPlugin, regeneration::RegenerationPlugin, skyblock::SkyblockPlugin,
        spawn::SpawnPlugin, stats::StatsPlugin, vanish::VanishPlugin, weather::WeatherPlugin,
    },
    skin::SkinPlugin,
};
